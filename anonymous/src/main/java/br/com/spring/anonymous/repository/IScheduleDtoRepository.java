...
public interface IScheduleDtoRepository extends JpaRepository<Schedule, Long> {
    ...
    @Query(value = "SELECT DISTINCT "
    		...
    		+ ",A.SCHEDULE_TYPE as scheduleType, A.SCHEDULE_VALUE as scheduleValue, A.VALID_FROM as validFrom "
        ...
        + "AND (:instance is null or a.INSTANCE LIKE %:instance%) and rownum <=20",
        nativeQuery = true)
